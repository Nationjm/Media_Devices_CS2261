...
enum {BLACKID=(256-10), WHITEID, GRAYID, REDID, GREENID, BLUEID, CYANID, MAGENTAID, YELLOWID, ORANGEID};
...
# 1 "road.h" 1
# 21 "road.h"
extern const unsigned short roadBitmap[19200];
...
# 1 "car.h" 1
# 21 "car.h"
extern const unsigned short carBitmap[200];
...
# 1 "cone.h" 1
# 21 "cone.h"
extern const unsigned short coneBitmap[72];


extern const unsigned short conePal[256];
# 8 "game.c" 2
...
# 21 "car2.h"
extern const unsigned short car2Bitmap[200];


extern const unsigned short car2Pal[256];
# 10 "game.c" 2
# 1 "rocket.h" 1
# 21 "rocket.h"
extern const unsigned short rocketBitmap[512];
...
# 1 "explosion.h" 1
# 21 "explosion.h"
extern const unsigned short explosionBitmap[512];


extern const unsigned short explosionPal[256];
# 12 "game.c" 2
# 1 "explosion2.h" 1
# 21 "explosion2.h"
extern const unsigned short explosion2Bitmap[2048];


extern const unsigned short explosion2Pal[256];
# 13 "game.c" 2
# 1 "analogSound.h" 1
...
int highscore = 0;
int highscoreUpdate = 0;


char printScore[41];
char printHighScore[41];

void initGame() {

    unsigned short colors[10] = {(((0) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10), (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10), (((15) & 31) | ((15) & 31) << 5 | ((15) & 31) << 10), (((31) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10), (((0) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10), (((0) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10), (((0) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10), (((31) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10), (((31) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10), (((31) & 31) | ((20) & 31) << 5 | ((0) & 31) << 10)};


    initGamePal();
    for (int i = 0; i < 10; i++) {
        ((volatile unsigned short*) 0x05000000)[256-10 +i] = colors[i];
    }
    initSound();
}
...
void updateCar() {
    if ((~(buttons) & ((1 << 5))) && (car.x > 2)) {
        car.x -= car.xVel;
    } else if ((~(buttons) & ((1 << 4))) && (car.x + car.width < 100)) {
        car.x += car.xVel;
    }
    if ((~(buttons) & ((1 << 6))) && (car.y > 0)) {
        car.y -= car.yVel;
    } else if ((~(buttons) & ((1 << 7))) && (car.y + car.height < 160)) {
        car.y += car.yVel;
    }
    drawCar();
}
...
void initGamePal() {
    DMANow(3, roadPal, ((volatile unsigned short*) 0x05000000), 512 / 2);
}
