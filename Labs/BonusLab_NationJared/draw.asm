...
VBUFF:  .word   0x6000000 @ TODO 1.1 Fill in the Video Buffer Address (hex or decimal works here)
WHITE:	.word	32767
RED:	.word	31
GREEN: 	.word	992
BLUE:	.word	31744
MYCOLOR:	.word	20345	@ TODO 1.2 Pick your own color (replacing zero!)
...
vline1loop:
	...
	strh r2, [r3]
	add r4, r4, #1 @ TODO: 1.4 i++; (remember r4 is i)
	cmp r4, #20			@ Compare i to 20
	blt vline1loop @ TODO: 1.5 loop again if i < 20 -- b{condition} LBLNAME
