...
int main() {
    ...
    while (1) {
        ...
        if ((!(~(oldButtons) & ((1<<0))) && (~(buttons) & ((1<<0)))) || (!(~(oldButtons) & ((1<<5))) && (~(buttons) & ((1<<5)))) || (!(~(oldButtons) & ((1<<4))) && (~(buttons) & ((1<<4)))) || (!(~(oldButtons) & ((1<<9))) && (~(buttons) & ((1<<9)))) || (!(~(oldButtons) & ((1<<8))) && (~(buttons) & ((1<<8))))) {
        ...
        if ((~(buttons) & ((1<<0)))) {
            shadowOAM[0].attr2 = (((4) * 32 + (4)) & 0x3FF);
        ...
        if ((~(buttons) & ((1<<5)))) {
            shadowOAM[1].attr2 = (((4) * 32 + (0)) & 0x3FF);

        } else {
            shadowOAM[1].attr2 = (((0) * 32 + (0)) & 0x3FF);

        }

        if ((~(buttons) & ((1<<4)))) {
            shadowOAM[2].attr2 = (((4) * 32 + (8)) & 0x3FF);

        } else {
            shadowOAM[2].attr2 = (((0) * 32 + (8)) & 0x3FF);

        }

        if ((~(buttons) & ((1<<9)))) {
            shadowOAM[6].attr0 = ((5) & 0xFF) | (0<<14);

        } else {
            shadowOAM[6].attr0 = ((3) & 0xFF) | (0<<14);

        }

        if ((~(buttons) & ((1<<8)))) {
            shadowOAM[7].attr0 = ((5) & 0xFF) | (0<<14);

        } else {
            shadowOAM[7].attr0 = ((3) & 0xFF) | (0<<14);
...
void initialize() {
    ...
    (*(volatile unsigned short*)0x4000008) = (0 << 7) | (0 << 14) | ((0) << 2) | ((20) << 8);
    (*(volatile unsigned short*)0x400000C) = (0 << 7) | (0 << 14) | ((1) << 2) | ((24) << 8);

    DMANow(3, &screenPal[16], &((unsigned short *)0x5000000)[16], 16);
    DMANow(3, screenTiles, &((charblock *)0x06000000)[1], 3680 / 2);

    DMANow(3, gbaplayerPal, ((unsigned short *)0x5000000), 16);
    DMANow(3, gbaplayerTiles, &((charblock *)0x06000000)[0], 2848 / 2);
    DMANow(3, gbaplayerMap, &((screenblock *)0x6000000)[20], 2048 / 2);

    ((unsigned short *)0x5000000)[0] = (((2) & 31) | ((2) & 31) << 5 | ((2) & 31) << 10);

    DMANow(3, buttonsPal, ((u16 *)0x5000200), 512 / 2);
    DMANow(3, buttonsTiles, (void*) 0x06010000, 32768 / 2);

    hideSprites();

    shadowOAM[0].attr0 = ((128) & 0xFF) | (0<<14);
    shadowOAM[0].attr1 = ((108) & 0x1FF) | (2<<14);
    shadowOAM[0].attr2 = (((0) * 32 + (4)) & 0x3FF);

    shadowOAM[1].attr0 = ((130) & 0xFF) | (0<<14);
    shadowOAM[1].attr1 = ((70) & 0x1FF) | (2<<14);
    shadowOAM[1].attr2 = (((0) * 32 + (0)) & 0x3FF);

    shadowOAM[2].attr0 = ((130) & 0xFF) | (0<<14);
    shadowOAM[2].attr1 = ((142) & 0x1FF) | (2<<14);
    shadowOAM[2].attr2 = (((0) * 32 + (8)) & 0x3FF);

    shadowOAM[3].attr0 = ((34) & 0xFF) | (0<<14) | (2<<8);
    shadowOAM[3].attr1 = ((195) & 0x1FF) | (0<<14);
    shadowOAM[3].attr2 = (((0) * 32 + (12)) & 0x3FF);

    shadowOAM[4].attr0 = ((33) & 0xFF) | (0<<14) | (2<<8);
    shadowOAM[4].attr1 = ((159) & 0x1FF) | (1<<14);
    shadowOAM[4].attr2 = (((1) * 32 + (12)) & 0x3FF);

    shadowOAM[5].attr0 = ((33) & 0xFF) | (0<<14) | (2<<8);
    shadowOAM[5].attr1 = ((64) & 0x1FF) | (1<<14);
    shadowOAM[5].attr2 = (((3) * 32 + (12)) & 0x3FF);

    shadowOAM[6].attr0 = ((3) & 0xFF) | (0<<14);
    shadowOAM[6].attr1 = ((2) & 0x1FF) | (2<<14);
    shadowOAM[6].attr2 = (((8) * 32 + (0)) & 0x3FF) | (((3) & 3) << 10);

    shadowOAM[7].attr0 = ((3) & 0xFF) | (0<<14);
    shadowOAM[7].attr1 = ((206) & 0x1FF) | (2<<14);
    shadowOAM[7].attr2 = (((8) * 32 + (4)) & 0x3FF) | (((3) & 3) << 10);
...
void off() {
    if ((!(~(oldButtons) & ((1<<3))) && (~(buttons) & ((1<<3))))) goToOn();
    seed++;
...
void on() {
    if ((!(~(oldButtons) & ((1<<3))) && (~(buttons) & ((1<<3))))) goToOff();
    update();
