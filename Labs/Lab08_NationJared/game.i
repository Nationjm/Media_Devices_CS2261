...
void initGame() {
    ...
    DMANow(3, connectFourTiledMap, &((CB*) 0x6000000)[1], (2048) / 2);
...
void animateChip() {
    ...
    shadowOAM[chipSprite.oamIndex].attr2 = (((currentColor->spritePaletteRow) & 0xF) <<12) | (512 + (((0)*32+(chipSprite.currentFrame * 2)) & 0x3FF));
...
void dropChip() {
    ...
    if ((((SB*) 0x6000000)[8].tilemap[((5 + depth) * (32) + (9 + currentColumn))] & 1023) != EMPTY_CELL) {
        ...
        if (gameStatus != DRAW) {
            ...
            for (int i = 0; i < 14; i++) {
                if (i < 7) {
                    (((SB*) 0x6000000)[8].tilemap[((13) * (32) + (10 + i))]) |= ((currentColor->winTextPaletteRow & 15) << 12);
                } else {
                    (((SB*) 0x6000000)[8].tilemap[((14) * (32) + (10 + i - 7))]) |= ((currentColor->winTextPaletteRow & 15) << 12);
                }
            }
        ...
        if (depth > 0) {
            ...
            ((SB*) 0x6000000)[8].tilemap[((depth + 4) * (32) + (9 + currentColumn))] = (EMPTY_CELL & 1023);
