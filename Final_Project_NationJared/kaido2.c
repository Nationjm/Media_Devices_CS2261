...
// extern OBJ_ATTR shadowOAM[128]; // Set up the shadowOAM

// extern int luffyLives;
// extern int kaidoHealth;
// extern int luffyPunched;
// extern int kaidoWordOAMIndex = 19;
// extern int rSeed;
// extern int punchDamage = 1;
// extern int gearFifth = 0;
// extern int groundChanging = 0;
// extern int groundFrames = 0;
// extern int tileTemp = 0;
...
// void luffyPunching2() { // Handle animating Luffy while his punching variable is set to 1
...
//     if (punchCollision2() & (luffyPunched == 1)) {
//         luffyPunched = 0;
...
//     if (fireballCollision2() && fireball.shooting) {
//         fireball.shooting = 0;
//         fireball.x = kaido.x + (kaido.width * 2) - 25;
//         luffyLives--;
//         if (luffyLives == 0) {
