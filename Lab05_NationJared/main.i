...
void goToStart() {
    fillScreen(((18&31) | (19&31) << 5 | (27&31) << 10));


    char letters[8] = {'G', 'A', 'M', 'E', ' ', 'B', 'O', 'Y'};
    unsigned short colors[8] = {((31&31) | (0&31) << 5 | (0&31) << 10), ((31&31) | (15&31) << 5 | (0&31) << 10), ((31&31) | (31&31) << 5 | (0&31) << 10), ((0&31) | (31&31) << 5 | (0&31) << 10), ((0&31) | (0&31) << 5 | (31&31) << 10), ((0&31) | (31&31) << 5 | (31&31) << 10), ((0&31) | (16&31) << 5 | (16&31) << 10), ((31&31) | (0&31) << 5 | (31&31) << 10)};
    int col = 72;
    int spacing = 12;
    for(int i = 0; i < 8; i++){
    ...
    drawString(84, 96, "fall 2023", ((15&31) | (15&31) << 5 | (15&31) << 10));
...
void goToGame() {
    fillScreen(((28&31) | (29&31) << 5 | (30&31) << 10));

    drawString(180, 1, "score: ", ((31&31) | (13&31) << 5 | (21&31) << 10));
...
void game() {
    ...
    drawRect(220, 1, 12, 8, ((28&31) | (29&31) << 5 | (30&31) << 10));
    drawString(220, 1, buffer, ((18&31) | (19&31) << 5 | (27&31) << 10));
...
void goToPause() {
    fillScreen(((28&31) | (29&31) << 5 | (30&31) << 10));
    drawString(136, 8, "got too stressed?", ((5&31) | (26&31) << 5 | (25&31) << 10));
    drawString(130, 18, "you're paused now!", ((5&31) | (26&31) << 5 | (25&31) << 10));
    waitForVBlank();
    state = PAUSE;
}
...
void goToWin() {
    fillScreen(((28&31) | (29&31) << 5 | (30&31) << 10));
    drawString(154, 8, "omg you won!!!", ((5&31) | (26&31) << 5 | (25&31) << 10));
    drawString(88, 18, "press start to play again", ((5&31) | (26&31) << 5 | (25&31) << 10));
    waitForVBlank();
    state = WIN;
}
...
void goToLose() {
    fillScreen(((28&31) | (29&31) << 5 | (30&31) << 10));
    drawString(172, 8, "you lost :(", ((5&31) | (26&31) << 5 | (25&31) << 10));
    drawString(94, 18, "better luck next time <3", ((5&31) | (26&31) << 5 | (25&31) << 10));
    drawString(94, 28, "press start to try again", ((5&31) | (26&31) << 5 | (25&31) << 10));
    waitForVBlank();
    state = LOSE;
}
