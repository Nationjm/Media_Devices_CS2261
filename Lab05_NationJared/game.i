...
void initPlayer() {
    ...
    player.height = 5;
    player.width = 35;
    player.color = ((31&31) | (27&31) << 5 | (18&31) << 10);
}
...
void initBall() {
    ...
    ball.height = 3;
    ball.width = 3;
    ball.color = ((18&31) | (19&31) << 5 | (27&31) << 10);
}
...
void initBlocks() {
    for (int i = 0; i < 30; i++) {
        ...
        switch (colorPicker) {
            case 0:
                blocks[i].color = ((0&31) | (16&31) << 5 | (16&31) << 10);
                break;
            case 1:
                blocks[i].color = ((0&31) | (21&31) << 5 | (20&31) << 10);
                break;
            case 2:
                blocks[i].color = ((31&31) | (20&31) << 5 | (26&31) << 10);
                break;
            case 3:
                blocks[i].color = ((22&31) | (6&31) << 5 | (13&31) << 10);
                break;
            case 4:
                blocks[i].color = ((19&31) | (9&31) << 5 | (13&31) << 10);
                break;
        }
    }
...
void drawPlayer() {
    drawRect(player.oldx, player.oldy, player.width, player.height, ((28&31) | (29&31) << 5 | (30&31) << 10));
    drawRect(player.x, player.y, player.width, player.height, player.color);
}


void drawBall() {
    drawRect(ball.oldx, ball.oldy, ball.width, ball.height, ((28&31) | (29&31) << 5 | (30&31) << 10));
...
void drawBlocks(BLOCK* b) {
    ...
    if (b->active) {
        drawRect(b->oldx, b->oldy, b->width, b->height, ((28&31) | (29&31) << 5 | (30&31) << 10));
        drawRect(b->x, b->y, b->width, b->height, b->color);
    } else if (!b->erased) {
        drawRect(b->x, b->y, b->width, b->height, ((28&31) | (29&31) << 5 | (30&31) << 10));
        b->erased = 1;
    }
}
